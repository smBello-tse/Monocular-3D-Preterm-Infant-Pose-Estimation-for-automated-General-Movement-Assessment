...
def load_backbone(args):
    ...
    if args.backbone=='PoseMamba':
        model_backbone = PoseMamba(num_frame=args.maxlen, embed_dim_ratio=args.dim_feat, mlp_ratio = args.mlp_ratio, depth = args.depth, model_type=args.model_type)
        ...
        model_backbone = DSTformer(dim_in=3, dim_out=3, dim_feat=args.dim_feat, dim_rep=args.dim_rep, 
                                   ...
                                   maxlen=args.maxlen, num_joints=args.num_joints, model_type=args.model_type)
