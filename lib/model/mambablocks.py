...
class BiSTSSM_v2:
    def __initv2__(
        ...
        **kwargs,    
        ...
        FORWARD_TYPES = dict(
            ...
            v2_fs_ft=partial(self.forward_corev2, force_fp32=(not self.disable_force32), CrossScan=CrossScan_fs_ft, SelectiveScan=SelectiveScanOflex, CrossMerge=CrossMerge_fs_ft),
            v2_fs_bt=partial(self.forward_corev2, force_fp32=(not self.disable_force32), CrossScan=CrossScan_fs_bt, SelectiveScan=SelectiveScanOflex, CrossMerge=CrossMerge_fs_bt),
            v2_bs_ft=partial(self.forward_corev2, force_fp32=(not self.disable_force32), CrossScan=CrossScan_bs_ft, SelectiveScan=SelectiveScanOflex, CrossMerge=CrossMerge_bs_ft),
            v2_bs_bt=partial(self.forward_corev2, force_fp32=(not self.disable_force32), CrossScan=CrossScan_bs_bt, SelectiveScan=SelectiveScanOflex, CrossMerge=CrossMerge_bs_bt),
            v2_plus_poselimbs=partial(self.forward_corev2, force_fp32=(not self.disable_force32), CrossScan=CrossScan_plus_poselimbs, SelectiveScan=SelectiveScanOflex, CrossMerge=CrossMerge_plus_poselimbs),
    ...
    def forwardv2(self, x: torch.Tensor, **kwargs):
        x = x.to(self.in_proj.weight.device)
        x = self.in_proj(x)
